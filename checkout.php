      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="/labs/lab1/SE PROJECT/home.php">Home <i class="fa fa-chevron-right"></i></a></span> <span>Checkout <i class="fa fa-chevron-right"></i></span></p>
	          	...
	          	<div class="col-md-6">
	          		<div class="cart-detail p-3 p-md-4">
	          			<h3 class="billing-heading mb-4">Payment Method</h3>
									...
									<form method="POST">
										<button type="submit" name="pay" class="btn btn-primary py-3 px-4">Place an order</button>
									</form>
								</div>
					 <?php 
					...
					if(isset($_POST['pay'])){
						...
						$result = mysqli_query($con,"INSERT INTO order_ (user_id,quantity,order_date,price) values('".$_SESSION['userId']."','".$_SESSION['total']."','".date('Y-m-d')."','".$_SESSION['price']."');");
						$result = mysqli_query($con,"SELECT * FROM order_ ");
						$work = mysqli_fetch_all($result,MYSQLI_ASSOC);
						$order_id=$work[count($work)-1]['order_id'];
					
					foreach($_SESSION['cart'] as $product){
						$result = mysqli_query($con,"INSERT INTO order_drink(drink_id,order_id,quantity) values('".$product['drink_id']."','".$order_id."',1)");
						$result = mysqli_query($con,"UPDATE drink SET drink_stock ='".--$product['drink_stock']."' WHERE drink_id='".$product['drink_id']."'");
						
					}
				
					echo "<script>alert('Your order accepted please log in again if you wants to make an other order')</script>";
					session_destroy();
