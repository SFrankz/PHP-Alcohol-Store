	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
          ...
          <div class="">
				    ...
				    <div class=" d-flex align-items-start" href="/labs/lab1/SE PROJECT/cart.php">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="/labs/lab1/SE PROJECT/home.php">Home <i class="fa fa-chevron-right"></i></a></span> <span>Products <i class="fa fa-chevron-right"></i></span></p>
...
?>
			...
			<div class="row">
                    ...
                    <div class="col align-self-center text-right text-muted"><?php echo count($session['ProductList']);?> products</div>
                </div>
				<?php 
				error_reporting(0);
		...
		echo "
            ...
            <div class='row border-top border-bottom' style='padding:5%'>
                <div class='row main align-items-center'>
				<div class='col'>
					<form action='' method='post'>
						<button name='Add1'  class='button button5' value='".++$session['i']."'>Add to cart</button>
					</form>
			...
			";
					...
					if(isset($_POST['Add1'])){
						$_SESSION['id']=$session['ProductList'][$_POST['Add1']--]['drink_id']; 
						
						$_SESSION['cart'][$_SESSION['j']++] = $session['ProductList'][$_POST['Add1']--];
