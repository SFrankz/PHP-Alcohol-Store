...
<html lang="en">
  ...
  <div class="wrap">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="/labs/lab1/SE PROJECT/homeSE.php">SE <span>Liquor</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="/labs/lab1/project2/works/homeSE.php" class="nav-link">Home</a></li>
    			...
    			<div class="col-md-4 d-flex">
    				<div class="intro d-lg-flex w-100 ftco-animate">
    					...
    					<div class="text">
    						...
    						<p>We are online 24/7,please dont hesitate to contact us!.</p>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-4 d-flex">
    				<div class="intro color-1 d-lg-flex w-100 ftco-animate">
    					...
    					<div class="text">
    						...
    						<p>Had some issues during your shopping? Don't worry, your money is safe!</p>
    					</div>
    				</div>
    			</div>
    			<div class="col-md-4 d-flex">
    				<div class="intro color-2 d-lg-flex w-100 ftco-animate">
    					...
    					<div class="text">
    						...
    						<p>We ship all around the country,and its for FREE!.</p>
    					</div>
    				</div>
    			</div>
    		</div>
    ...
    <section class="ftco-section ftco-no-pb">
			<div class="container">
	          ...
	          <div class="heading-section">
	            ...
	            <p>We are SE Liquor Store,we opened our store in 2010 in a small store in our neighborhood,people doubted our business becuase they though its kinda slizzy,but we showed them wrong.</p>
	            <p>After several months since our opening,people started to pay attention to us,coming inside they were given some taste samples of our fine alcohol,they immediately fell in love with out liquor,and since then we became successful.</p>
	            <p class="year">
		...
		<section class="ftco-section ftco-no-pb">
			<div class="container">
				...
				<div class="row justify-content-center">
					<div class="col-md-4">
						<a href="/labs/lab1/SE PROJECT/proudctClient.php" class="btn btn-primary d-block">View All Products <span class="fa fa-long-arrow-right"></span></a>
					</div>
				</div>
			</div>
		</section>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap py-4">
                  ...
                  <div class="text">
                    <p class="mb-4">This is delightful!</p>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></div>
                  <div class="text">
                    <p class="mb-4">Excellent Quality!.</p>
                    <div class="d-flex align-items-center">
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></div>
                  <div class="text">
                    <p class="mb-4">Best I've ever tasted!.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/person_3.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Dan Black</p>
		                    <span class="position">Client</span>
		                  </div>
	                  </div>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></div>
                  <div class="text">
                    <p class="mb-4">The prices are so good!.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/person_1.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">John Rich</p>
		                    <span class="position">Client</span>
		                  </div>
	                  </div>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                	<div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-quote-left"></div>
                  <div class="text">
                    <p class="mb-4">The Service Was Great!.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url(images/person_2.jpg)"></div>
                    	<div class="pl-3">
		                    <p class="name">Ben Red</p>
		                    <span class="position">Client</span>
		                  </div>
	                  </div>
                  </div>
